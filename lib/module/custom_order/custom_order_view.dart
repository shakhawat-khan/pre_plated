...
class _CustomCurryOrderViewState extends State<CustomCurryOrderView> {
  ...
  final vegetables = [
    'Potato', 'Cauliflower', 'Spinach', 'Eggplant', 'Peas', 'Mixed Veggies'
  ];
  final proteins = [
    'Chicken', 'Beef', 'Lamb', 'Paneer', 'Tofu', 'No Protein'
  ];
  final bases = [
    'Rice', 'Naan', 'Roti', 'Quinoa', 'No Base'
  ];
  ...
  Widget buildStep({required String title, required List<String> options, required String? selected, required void Function(String) onSelect}) {
    return Column(
              ...
              children: List.generate(3, (i) => Expanded(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: i <= step ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.surfaceVariant,
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Your Selection:', style: Theme.of(context).textTheme.titleMedium),
                      const SizedBox(height: 8),
                      Row(
                        children: [
                          const Icon(Icons.eco, size: 18),
                          const SizedBox(width: 6),
                          Text(selectedVegetable ?? '-', style: const TextStyle(fontWeight: FontWeight.w500)),
                        ],
                      ),
                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 6),
                          Text(selectedProtein ?? '-', style: const TextStyle(fontWeight: FontWeight.w500)),
                        ],
                      ),
                      const SizedBox(height: 4),
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 6),
                          Text(selectedBase ?? '-', style: const TextStyle(fontWeight: FontWeight.w500)),
                        ],
                      ),
                      const SizedBox(height: 12),
                      Text('Specification (optional):', style: Theme.of(context).textTheme.bodyMedium),
              ...
              children: [
                ...
                if (step < 2)
                  ElevatedButton(
                    ...
                    onPressed: (step == 0 && selectedVegetable == null) || (step == 1 && selectedProtein == null)
                        ? null
                        : nextStep,
